...
object DynamicCommands : CommandCollection() {
    ...
    @JvmStatic
    @JvmOverloads
    fun buildCommand(name: String, builder: Function? = null): Registerable {
     ...
     */
    @JvmStatic
    fun angle() = wrapArgument(AngleArgumentType.angle(), DynamicCommands::AngleArgumentWrapper)
    ...
    fun blockPos(): ArgumentType<PosArgument> {
        return wrapArgument(BlockPosArgumentType.blockPos(), DynamicCommands::PosArgumentWrapper)
    }
    ...
    fun blockPredicate(): ArgumentType<BlockPredicateWrapper> {
        ...
        return wrapArgument(predicate, DynamicCommands::BlockPredicateWrapper)
    }
    ...
    fun blockState(): ArgumentType<BlockStateArgumentWrapper> {
        ...
        return wrapArgument(predicate, DynamicCommands::BlockStateArgumentWrapper)
    }
     ...
     */
    @JvmStatic
    fun columnPos() = wrapArgument(ColumnPosArgumentType.columnPos(), DynamicCommands::PosArgumentWrapper)
    ...
    fun itemStack(): ArgumentType<ItemStackArgumentWrapper> {
        ...
        return wrapArgument(arg, DynamicCommands::ItemStackArgumentWrapper)
    }
     ...
     */
    @JvmStatic
    fun message() = wrapArgument(MessageArgumentType.message(), DynamicCommands::MessageFormatArgumentWrapper)
     ...
     */
    @JvmStatic
    fun nbtPath() = wrapArgument(NbtPathArgumentType.nbtPath(), DynamicCommands::NbtPathWrapper)
     ...
     */
    @JvmStatic
    fun rotation() = wrapArgument(RotationArgumentType.rotation(), DynamicCommands::PosArgumentWrapper)
    ...
    @JvmStatic
    @JvmOverloads
    fun vec2(centerIntegers: Boolean = true) = wrapArgument(Vec2ArgumentType.vec2(centerIntegers), DynamicCommands::PosArgumentWrapper)
    ...
    @JvmStatic
    @JvmOverloads
    fun vec3(centerIntegers: Boolean = true) = wrapArgument(Vec3ArgumentType.vec3(centerIntegers), DynamicCommands::PosArgumentWrapper)
