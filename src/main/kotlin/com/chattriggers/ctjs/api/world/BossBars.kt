...
object BossBars {
    ...
    fun getBossBars(): List<BossBar> {
        return toMC()
            .asMixin<BossBarHudAccessor>().bossBars.values.map(BossBars::BossBar)
    }
    ...
    enum class Style(override val mcValue: MCBossBarStyle, val sections: Int) :
        CTWrapper<MCBossBarStyle> {
