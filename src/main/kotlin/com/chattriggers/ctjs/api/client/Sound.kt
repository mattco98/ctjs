...
class Sound(private val config: NativeObject) {
    ...
    private class InitialSoundData(config: NativeObject) : SoundData {
        ...
        override var category = config["category"]?.let(Category.Companion::from) ?: Category.MASTER
        override var attenuationType = config["attenuationType"]?.let(AttenuationType.Companion::from) ?: AttenuationType.LINEAR
    }
