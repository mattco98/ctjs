...
object Config : Vigilant(File(CTJS.configLocation, "ChatTriggers.toml"), sortingBehavior = CategorySorting) {
    ...
    init {
        ...
        listenToConsoleProperty(Config::clearConsoleOnLoad)
        listenToConsoleProperty(Config::openConsoleOnError)
        listenToConsoleProperty(Config::consoleFiraCodeFont)
        listenToConsoleProperty(Config::consoleFontSize)
        listenToConsoleProperty(Config::customTheme)
        listenToConsoleProperty(Config::consoleTheme)
        listenToConsoleProperty(Config::consoleTextColor)
        listenToConsoleProperty(Config::consoleBackgroundColor)
        listenToConsoleProperty(Config::consoleErrorColor)
        listenToConsoleProperty(Config::consoleWarningColor)
    }
