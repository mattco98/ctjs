...
class Inventory {
     ...
     */
    fun getStackInSlot(slot: Int): _root_ide_package_.com.chattriggers.ctjs.api.inventory.Item? = inventory?.getStack(slot)?.let(
        _root_ide_package_.com.chattriggers.ctjs.api.inventory.Item::fromMC)
